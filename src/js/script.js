document.addEventListener('DOMContentLoaded', () => {
  ...
  const projectContent = {
    comic: {
      ...
      description:
        'A groundbreaking fusion of AI generation, custom illustration styles, and strategic branding that transforms into an interactive comic book experience. This project showcases how modern technology can enhance storytelling while maintaining authentic artistic vision.',
    ...
    inspector: {
      ...
      description:
        'Complete brand identity and digital presence for a Chicago startup home inspection company. From logo conception to full website development, this project showcases comprehensive branding for a service-based business.',
    ...
    pet: {
      ...
      description:
        'An innovative print-to-digital bridge project featuring a unique red lens reveal mechanism. This uncommon print project challenged traditional design boundaries by creating an interactive physical experience.',
    },
    biomarin: {
      title: 'BioMarin Interactive Challenge',
      description:
        'An engaging "Beat the Clock" interactive experience designed for tradeshow booths, specifically focusing on Achondroplasia awareness. This gamified approach made complex medical information accessible and memorable.',
  ...
  const testimonials = [
    {
      text: 'I just first want to say that your work is simply lovely. I cannot express how happy I am with what you have shown me so far. You have captured the vision that I have for the website. Kudos to you!',
      author: 'DR. APH',
    },
    {
    ...
    {
      text: 'Rock-Solid, Badass, Figure-out-anything problem solver, Hard Worker, Motivated and Cool as Hell Powerhouse.',
      author: 'S.G.',
    },
    {
      text: 'You are so fun to work with because you are a real renaissance designer...',
      author: 'George B.',
    },
    {
    ...
    {
      text: 'Thanks for keeping me sane everyday. Appreciate your talent, dedication and friendship.',
      author: 'G.W.',
    },
    {
      text: 'Heather, You Rock! You have a heart of gold, and I love working with you. You bring great ideas to the table and overall make life a lot easier!',
      author: 'J.W.',
    },
    {
      text: 'We’re excited to see where we could continue to evolve this quiz and conference interactivity! Go Team go! Great work Heather!',
      author: 'J. N.',
    },
    {
      text: 'I know I have other priorities I need to start with this morning, but this was the project I couldn’t stop thinking about. You did such a great job storyboarding and copywriting this thing out.',
      author: 'D. B.',
    },
    ...
    {
      text: 'Heather was an absolute rockstar and beyond wonderful to work with! She was so responsive, quick, and had attention to detail - it made my job so easy! The client is so happy.',
      author: 'A.P-L',
    },
    {
      text: 'Your talent and attitude made this account a joy to work on and allowed us to do incredible work - “Best in Show” level work!',
      author: 'J.O.',
    },
  ];
  ...
  const rangeData = [
    ...
    },
    {
      ...
      subtitle: 'Fort Hays State University',
      type: 'education',
      color: '#FFD700',
    },
    {
      ...
      title: 'Shop Manager & Lead Designer',
      subtitle: 'HaysTees',
      type: 'experience',
      color: '#0047AB',
    },
    ...
    },
    {
      ...
      title: 'Roller Derby League',
      subtitle: 'Athlete & Volunteer',
      type: 'experience',
      color: '#DC2626',
    },
    {
      ...
      title: 'Sr Digital Developer',
      subtitle: 'Greteman Group',
      type: 'experience',
      color: '#06B6D4',
    },
    {
  ...
  function cycleTestimonials() {
    ...
    if (existingBubble) {
      ...
      existingBubble.addEventListener(
        'transitionend',
        () => {
